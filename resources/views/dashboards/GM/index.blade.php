<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('General Manager - Executive Dashboard') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <!-- Actions Panel -->
                <div class="space-y-6">
                    <!-- Quick Actions Card (GM Specific) -->
                    <div class="bg-slate-900 rounded-2xl shadow-lg p-6 text-white text-center">
                        ...
                        <h3 class="font-bold text-lg mb-2">Operational Control</h3>
                        <p class="text-slate-400 text-xs mb-6 px-4">Oversee daily operations and approve vetting requests.</p>
                        
                        <div class="grid grid-cols-1 gap-3">
                            <a href="{{ route('bill-management.gm.index') }}" class="bg-blue-600 hover:bg-blue-500 text-white py-3 rounded-xl font-bold text-sm transition flex items-center justify-center gap-2">
                                <i class="fas fa-tasks"></i> Operational Vetting
                            </a>
                        </div>
                    </div>
