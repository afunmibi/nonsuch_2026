            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('users.create') }}" class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700">Add New User</a>
                    </div>
                                ...
                                @forelse ($users as $user)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            @php
                                                $canDelete = (auth()->user()->role === 'admin' && auth()->id() !== $user->id) || 
                                                             (in_array(auth()->user()->role, ['gm', 'md']) && $user->role !== 'admin');
                                            @endphp
