<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(in_array(Auth::user()->role, ['admin', 'acc', 'gm', 'md']))
                    <x-nav-link :href="route('bill-management.accounts.index')" :active="request()->routeIs('bill-management.accounts.index')">
                        {{ __('Accounts Dept') }}
                    </x-nav-link>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(in_array(Auth::user()->role, ['admin', 'acc', 'gm', 'md']))
            <x-responsive-nav-link :href="route('bill-management.accounts.index')" :active="request()->routeIs('bill-management.accounts.index')">
                {{ __('Accounts Dept') }}
            </x-responsive-nav-link>
            @endif
